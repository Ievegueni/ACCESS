...
const ZH = {
  ...
  'ord.m.semConfirmacao': '已执行但未收到确认短信：重发前请先核查',
  'ord.m.falhaOperador': '运营商回复中没有“成功”',
  ...
  'dev.api.s.falhada': '运营商已回复，但未确认成功。原因见 <code>motivo</code>',
  'dev.api.s.falhada.f': '视下方的 <code>motivo</code> 而定。',
  'dev.api.s.expirada': '十分钟内未结束。原因见 <code>motivo</code>',
  'dev.api.s.expirada.f': '视下方的 <code>motivo</code> 而定。',
  'dev.api.motivo.nota': '指令未能正常结束时，<code>motivo</code> 说明原因；其余情况为 <code>null</code>。',
  'dev.api.motivo': '原因',
  'dev.api.m.naoRecolhida': '十分钟内没有设备取走该指令（无网络、关机）。未执行任何操作',
  'dev.api.m.naoRecolhida.f': '可以用新的 <code>ref</code> 重发。',
  'dev.api.m.semConfirmacao': '已执行，但十分钟内未收到运营商的确认',
  'dev.api.m.semConfirmacao.f': '不要盲目重发：先到第 4 节核查。',
  'dev.api.m.falhaOperador': '收到的确认中没有“成功”字样',
  'dev.api.m.falhaOperador.f': '按 <code>tid</code> 到第 4 节查看该笔转账。',
  'dev.api.m.operadorIndisponivel': '在发送金额之前，运营商回复“服务不可用”。我方每 30 秒重试一次，共 3 次。未执行任何操作',
  'dev.api.m.operadorIndisponivel.f': '可以用新的 <code>ref</code> 重发。',
  ...
  'dev.api.c.notify': '贵方的 <code>https://</code> 地址。指令变为 <code>concluida</code>、<code>falhada</code> 或 <code>expirada</code> 时，我方向该地址发送 <code>POST</code>，内容与状态查询的返回相同',
  ...
  'dev.api.r3.d': '<code>motivo</code> 为 <code>sem_confirmacao</code> 时，该操作可能已经执行完毕，只是确认丢失了 —— 所以我方绝不自动重发。创建新指令之前，请先到第 4 节的列表中核查这笔转账是否已经发生。若为 <code>nao_recolhida</code>，则未执行任何操作，可以重发。',
